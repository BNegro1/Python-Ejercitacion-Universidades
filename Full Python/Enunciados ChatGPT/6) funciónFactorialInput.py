...
def factorial(n):
    for x in range(1, n):
        n = n*x # La variable "x" seria el contador. Ejemplo:Si n = 4, x = (1, 2, 3). Debido a que
                # son las iteraciones.
    print(f"El factorial de {n_ingresado} es {n}: ")
    
while True: 
    n_ingresado = int(input("Ingrese un número para calcular factorial: "))
    factorial(n_ingresado)
